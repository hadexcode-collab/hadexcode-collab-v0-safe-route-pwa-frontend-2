...
export interface PeerDeviceData {
  deviceId?: string; // optional unique id of sender
  heading: number;
  location: {
    latitude: number;
    longitude: number;
...
export class WSClient {
  ...
  private isValidPeerData(data: unknown): data is PeerDeviceData {
    ...
    return (
      // deviceId is optional but if present should be a string
      (typeof obj.deviceId === 'undefined' || typeof obj.deviceId === 'string') &&
